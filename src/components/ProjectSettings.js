    ...
    return (
        <div className="flex">
            <div className="w-1/4 p-6 ">
                <button
                    className={`block w-full py-2 px-4 mb-2 rounded ${view === 'projectSettings' ? 'bg-[#7A79EA] text-white' : 'bg-white text-gray-700'}`}
                    onClick={() => setView('projectSettings')}
                >
                    Project Settings
                </button>
                <button
                    className={`block w-full py-2 px-4 rounded ${view === 'manageAccess' ? 'bg-[#7A79EA] text-white' : 'bg-white text-gray-700'}`}
                    ...
                    <div className="bg-white">
                        ...
                        {isOwner && (
                            <form onSubmit={handleUpdateProject} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#7A79EA] hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                >
                                    Update
                                </button>
                            </form>
