...
const Cards = () => {
  return (
    <div className='flex flex-wrap justify-center'>
      <motion.div className="bg-[#6c6bf8] p-8 rounded-md shadow-lg w-full sm:w-1/2 lg:w-1/4 xl:w-1/5 h-96 m-4 opacity-50" variants={fadeInUp}>
      ...
      <motion.div className="bg-[#a5a4ff] p-8 rounded-md shadow-lg w-full sm:w-1/2 lg:w-1/4 xl:w-1/5 h-96 m-4 opacity-50" variants={fadeInUp}>
