        ...
        >
          <div className='flex h-full px-6'>
            <div className='w-full md:w-1/2 lg:w-1/3 self-center'>
              ...
              <p className='text-black text-xl leading-relaxed mb-6'>DevLiftoff is committed to building the best platform available for understanding development workflows and project management. STAGING CHECK</p>
